      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand scroll" href="{{ URL::to('/') }}">
            <span class="chpc-logo"><img src="{{ URL::to('/') }}/themes/{{Session::get('theme')}}/assets/img/chpc-logo.png"/></span>
          </a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right chpc-links">
            ...
            <li @if(strpos($_SERVER['REQUEST_URI'], "pages/initiatives") !== false) class="active" @endif><a class="scroll" href="{{ URL::to('/') }}/pages/resources">Resources</a></li>
            <li @if(strpos($_SERVER['REQUEST_URI'], "pages/events") !== false) class="active" @endif><a class="scroll" href="{{ URL::to('/') }}/pages/events">Documentation</a></li>
